...
```bash
git clone https://github.com/tawanamohammadi/Marzban.git
cd Marzban
...
```bash
sudo bash -c "$(curl -sL https://github.com/tawanamohammadi/Marzban-scripts/raw/master/marzban.sh)" @ install-script
```
